...
// GG 2024.08.27 Ќаведение пор€дка в проблеме залипани€ частиц на поверхности.
// –еально из-за ошибок математических функций погрешность в вычислении
// рассто€ний может быть на несколько пор€дков больше DBL_EPSILON.
// ¬место этого устанавливаем свой порог, когда должны привлекатьс€ дополнительные методы
// определени€ моментов пересечени€ границы дополнительными к рассто€нию методами.
#ifndef MINDELTA
#define MINDELTA 1e-9
#endif

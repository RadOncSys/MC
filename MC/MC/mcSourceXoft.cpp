#include "mcSourceXoft.h"
#include "mcThread.h"
#include "../geometry/vec3d.h"
#include "mcPhysics.h"

mcSourceXoft::mcSourceXoft(const char* name, int nThreads,
...
mcSourceXoft::~mcSourceXoft(void)
{
}

void mcSourceXoft::sample(mcParticle& p, mcThread* thread)
{
...
void mcSourceXoft::dumpVRML(ostream& os) const
{
